...
const firstLoadWelcome = function () {
	...
	const video = '<iframe width="560" height="315" src="https://www.youtube.com/embed/Nmxd3vAiZdg?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
...
if (localStorage.getItem('FlauntSitesInitial') != 'true') {
	firstLoadWelcome()
}
