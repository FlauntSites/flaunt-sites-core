 ...
 * @subpackage Flaunt_Sites_Core/public
 */
 ...
 */
class Flaunt_Sites_Core_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/flaunt-sites-core-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/flaunt-sites-core-public.js', array( 'jquery' ), $this->version, false );
