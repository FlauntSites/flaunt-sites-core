...
-Conditional logic for Vimeo icon.
-Removed Image schema json stuff.
-Removed Sharebar loop.
-Removed Admin stuff.
-Removing Flaunt Sites Custom Post Types and Widgets.
...
-Added Vimeo to social media icons.
...
-Added a conditional to a JS function in the Login.js file.
